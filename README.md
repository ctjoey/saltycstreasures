# Salty C's Treasure — Website

Upscale coastal boutique site for **Salty C's Treasure**, handmade decoupage shells (magnets, ornaments, trinket dishes, wine stoppers). Domain target: **saltycstreasures.com**.
...
- **Social links**: point to `tiktok.com/@saltycstreasure` — update if the handle differs.
